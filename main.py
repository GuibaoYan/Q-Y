...
img_path = 'E:/Mixup/images/'           # 原始图片文件夹路径
save_path = 'E:/Mixup/mixJPG/'       # mixup的图片文件夹路径
xml_path = 'E:/Mixup/labels/'           # 原始图片对应的标注文件xml文件夹的路径
save_xml = 'E:/Mixup/mixXML/'        # mixup的图片对应的标注文件xml的文件夹路径
